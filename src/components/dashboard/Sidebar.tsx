...
export function Sidebar() {
    ...
    useEffect(() => {
        ...
        setUserName(localStorage.getItem('aegis_user_name') || 'Test Account');
    }, []);
    ...
    return (
        <aside className="w-64 border-r border-white/5 bg-[#0a0a0a] hidden md:flex flex-col justify-between h-screen sticky top-0 shrink-0 z-40">
            ...
            <div className="p-4 border-t border-white/5 relative">
                ...
                >
                    <div className="w-10 h-10 shrink-0 rounded-full bg-gradient-to-tr from-indigo-500 to-purple-500 flex items-center justify-center text-white font-bold tracking-tight">
                        {userName === "Loading..." ? "..." : userName.substring(0, 2).toUpperCase()}
                    </div>
